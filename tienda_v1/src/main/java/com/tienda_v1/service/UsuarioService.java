...
public interface UsuarioService {
    ...
    // Se inserta un nuevo usuario si el id del usuario esta vacÃ­o
    // Se actualiza un usuario si el id del usuario NO esta vacÃ­o
    public void save(Usuario usuario,boolean crearRolUser);
    
    // Se elimina el usuario que tiene el id pasado por parÃ¡metro
